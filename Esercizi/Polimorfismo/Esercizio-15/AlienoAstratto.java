/*
 *  15- Il seguente frammento di codice è stato progettato da J. Hacker per un video
 ...
 * 
 * 
 * 	15-	Rendere astratta la classe Alieno del precedente esercizio. Si renda astratto anche il
 * 		metodo getDanno.
 * 
 */

public abstract class AlienoAstratto {
	
	private int salute;
	private String nome;
	
	public AlienoAstratto() {
		salute = 0;
		nome = "";
	}
	
	public AlienoAstratto(int salute, String nome) {
		this.salute = salute;
		this.nome = nome;
	}
