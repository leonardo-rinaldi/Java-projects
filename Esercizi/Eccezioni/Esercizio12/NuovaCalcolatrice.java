...
import Esempio.DivisionePerZeroException;

import java.util.Scanner;

/*
    12- Mostrare le modifiche necessarie per aggiungere l'operazione di elevamento a
        potenza alla classe Calcolatrice. Usare il simbolo ^ per rappresentare
        l'operatore esponenziale e il metodo Math.pow per eseguire i calcoli
 */

public class NuovaCalcolatrice {

    private double risultato;
    private double precisione = 0.0001;
    //Numeri così prossimi a zero sono considerati pari a zero.

    public NuovaCalcolatrice() {
        risultato = 0;
    }
    ...
    public void eseguiCalcoli() throws DivisionePerZeroException, OpSconosciutaException{
        ...
        while(!fatto) {
            ...
            if((prossimaOp == 'f') || (prossimaOp == 'F')) {
                ...
                System.out.println("risultato " + prossimaOp + " " + prossimoNumero + " = " + risultato);
    ...
    public static void main(String[] args) {
        NuovaCalcolatrice calc = new NuovaCalcolatrice();

        try {
            System.out.println("Calcoaltrice attivata.");
            System.out.print("Formato di ogni riga: ");
            System.out.println("operatore spazio numero");
            System.out.println("Per esempio: + 3");
            System.out.println("Per terminare inserire la lettera 'f'.");
        ...
        System.out.println("Il risultato finale è " + calc.getRisultato());
        System.out.println("Fine del programma.");
    }
}
