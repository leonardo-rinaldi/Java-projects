...
/*
 * 	3-	Si consideri la classe Punteggio che rappresenta un punteggio numerico per 
 ...
 * 		  essere stampato.
 * 
 * 		Si scrivano inoltre un costruttore di default e un secondo costruttore per
 * 		la classe Punteggio.
 * 	
 */
...
public class Punteggio {
	...
	public Punteggio(String descrizioneOggetto, int punteggioMassimo, int punteggio) {
